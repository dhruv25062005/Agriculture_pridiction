...
express.application.get = function(route, ...handlers) {
  ...
  // IMPORTANT: do not replace /weather here. weather-hardening.js is loaded
  // before this module and owns the /weather validation/guard. The legacy
  // server /weather handler also provides the advisory fields consumed by the
  // dashboard: spray_score, spray_badge, spray_reason, spray_window,
  // irrigation_advice and fungal-risk values.
